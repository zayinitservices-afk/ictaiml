          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100">
              ...
              <p className="text-gray-700 mb-4">
                All accepted and presented papers will be published in the ICECAA 2025 Conference Proceedings.
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <p>Papers must follow IEEE double-column format. Maximum length: 8 pages (regular papers) or 4 pages (short papers), excluding references.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">Camera-Ready Submission</h3>
                <p>Camera-ready papers must be submitted by August 15, 2025. Authors must incorporate reviewer feedback and ensure compliance with formatting guidelines.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">Copyright</h3>
                <p>Authors must sign the IEEE copyright form upon acceptance. The copyright will be transferred to IEEE for proceedings publication.</p>
              </div>
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-lg mb-2">Plagiarism Policy</h3>
                <p>All submissions will be checked for plagiarism. Papers with similarity index above 20% will be rejected.</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl shadow-lg p-8 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-lg">August 15, 2025</p>
              </div>
              <div>
